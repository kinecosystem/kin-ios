...
public class StellarSdkProxy {
    ...
    func streamTransactions(for accountId: String, cursor: String?) -> TransactionsStreamItem {
        return sdk.transactions.stream(for: .transactionsForAccount(account: accountId, cursor: cursor))
    }
}
