...
class KinServiceTests: XCTestCase {
    ...
    func testGetAccountError() {
        let error = KinService.Errors.unknown
        let stubResponse = GetAccountResponse(result: .error,
                                              error: error,
                                              account: nil)
        mockKinAccountApi.stubGetAccountResponse = stubResponse
    ...
    func testGetTransactionError() {
        let error = KinService.Errors.unknown
        let expectResponse = GetTransactionResponse(result: .error,
                                                    error: error,
                                                    kinTransaction: nil)
        mockKinTransactionApi.stubGetTransactionResponse = expectResponse
    ...
    func testGetLatestTransactionsError() {
        let error = KinService.Errors.unknown
        let expectResponse = GetTransactionHistoryResponse(result: .error,
                                                           error: error,
                                                           kinTransactions: nil)
        mockKinTransactionApi.stubGetTransactionHistoryResponse = expectResponse
    ...
    func testGetTransactionPageError() {
        let error = KinService.Errors.unknown
        let expectResponse = GetTransactionHistoryResponse(result: .error,
                                                           error: error,
                                                           kinTransactions: nil)
    ...
    func testStreamNewTransactions() {
        mockKinTransactionApi.stubNewTransactionsStream = Observable<KinTransaction>()
        XCTAssertNoThrow(sut.streamNewTransactions(accountId: "id"))
    }

    func testStreamAccount() {
        mockKinAccountApi.stubAccountStream = Observable<KinAccount>()
